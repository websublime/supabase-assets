...
const file_type_1 = __nccwpck_require__(970);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const destiny = core.getInput('destiny');
            ...
            const assets = yield (0, utils_1.walk)(folder);
            const upload = () => __awaiter(this, void 0, void 0, function* () {
                for (const asset of assets) {
                    ...
                    const { mime = 'text/plain;charset=UTF-8' } = (yield (0, file_type_1.fileTypeFromBuffer)(file)) || {};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fileBuffer = exports.walk = void 0;
...
function walk(directory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of files) {
            ...
            if ((yield (0, promises_1.stat)(path)).isDirectory()) {
                fileList = [...fileList, ...(yield walk(path))];
            }
            else {
                fileList.push(path);
            }
...
async function fileTypeStream(readableStream, {sampleSize = minimumBytes} = {}) {
	...
	const {default: stream} = await Promise.resolve(/* import() */).then(__nccwpck_require__.t.bind(__nccwpck_require__, 8725, 19));
